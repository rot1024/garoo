...
>(({ className, children, hideClose, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Centered via inset-0 + margin-auto (not translate) so transform-based
        // enter/exit animations (slide/zoom) can play without fighting the
        // centering. h-fit keeps default dialogs sized to content.
